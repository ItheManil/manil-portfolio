...
export const techIconMap: Record<string, { icon: string; color: string; invert?: boolean }> = {
  'React.js': { icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg', color: '190 90% 50%' },
  'Node.js': { icon: nodejsLogo, color: '120 40% 45%' },
  'Express.js': { icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg', color: '0 0% 70%', invert: true },
  ...
  'Tailwind CSS': { icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/tailwindcss/tailwindcss-original.svg', color: '190 80% 50%' },
  ...
  'PostgreSQL': { icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg', color: '210 50% 50%' },
